...
export const Endpoints = {
	...
	MANAGED_BOT_OPTIONS: '/bots/options',
	MANAGED_BOTS: '/bots',
	MANAGED_BOT: (applicationId: string) => `/bots/${applicationId}`,
	MANAGED_BOT_REPROVISION: (applicationId: string) => `/bots/${applicationId}/reprovision`,
